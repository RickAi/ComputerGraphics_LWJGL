...
public class Tetrahedron {
	...
	// I have implemented this for you as we have not covered enough openGL to
	// allow you to complete the assignment without a reference class.
	// This should be your reference to aid you in completing all the other
	// Objects3D classes.
